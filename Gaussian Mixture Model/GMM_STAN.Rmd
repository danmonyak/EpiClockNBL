...
params:
  cloud_path: "~/Library/CloudStorage/Box-Box/PROJECT 06023: MolClocks/Neuroblastoma_Paper/Datasets/Heinrich/"
  beta_vals_file: Henrich.methyl.TARGET_Clock_sites.tsv
  output_file: "Heinrich_tumor_params_GMM_summary.csv"
---
...
write.csv(tumor_params, params$output_file, row.names = FALSE)
