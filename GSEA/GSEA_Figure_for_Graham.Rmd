...
params:
  ...
  pos_file: "~/Library/CloudStorage/Box-Box/PROJECT 06023: MolClocks/Neuroblastoma_Paper/GSEA/TARGET/NBL_cluster_gmm_phi.Gsea.1741669700509/gsea_report_for_neuroblastoma_gmm_phi_pos_1741669700509.tsv"
  neg_file: "~/Library/CloudStorage/Box-Box/PROJECT 06023: MolClocks/Neuroblastoma_Paper/GSEA/TARGET/NBL_cluster_gmm_phi.Gsea.1741669700509/gsea_report_for_neuroblastoma_gmm_phi_neg_1741669700509.tsv"
  names:
    - "$C_{\\beta}$"
    - "$C_{\\beta}^{\\alpha}$"
  fdr_limit: 0.1
