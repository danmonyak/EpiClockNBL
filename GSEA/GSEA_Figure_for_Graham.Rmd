...
params:
  ...
  pos_file: "~/Library/CloudStorage/Box-Box/PROJECT 06023: MolClocks/Neuroblastoma_Paper/GSEA/TARGET/neuroblastoma.Gsea.1733456225610/gsea_report_for_neuroblastoma_c_beta_pos_1733456225610.tsv"
  neg_file: "~/Library/CloudStorage/Box-Box/PROJECT 06023: MolClocks/Neuroblastoma_Paper/GSEA/TARGET/neuroblastoma.Gsea.1733456225610/gsea_report_for_neuroblastoma_c_beta_neg_1733456225610.tsv"
  names:
    - "$C_{\\beta}$"
    - "$C_{\\beta}^{\\alpha}$"
  fdr_limit: 0.1
