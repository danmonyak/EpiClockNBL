...
write.table(raw_counts, file = paste0(save_path, params$gene_filename, "_raw_counts.tsv"), 
            sep = "\t")
...
write.table(query_clinical_flat, file = paste0(save_path, params$clinical_filename, ".tsv"), sep = "\t")
